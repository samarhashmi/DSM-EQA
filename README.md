...
1. **Physics-consistent system states:** 10,000 states were generated by sampling load variability, renewable penetration, and fault scenarios, all verified against power balance, voltage (0.95–1.05 pu), and thermal limits (≤ 1.00 pu).
